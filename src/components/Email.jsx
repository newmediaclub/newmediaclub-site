...
class Email extends React.Component {
	render() {
		...
		<form className="validate flex flex-row" action="https://rit.us14.list-manage.com/subscribe/post?u=8ed84f128f439d4ab46e02db7&amp;id=e367bf5ac6" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank" rel="noopener noreferrer" noValidate="novalidate">
